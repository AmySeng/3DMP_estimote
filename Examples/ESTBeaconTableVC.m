...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([beacon isKindOfClass:[CLBeacon class]])
    {
        ...
        cell.detailTextLabel.text = [NSString stringWithFormat:@"Distance: %.2f, Count: %tu", cBeacon.accuracy, self.count];
    }
...
//    self.countString = [NSString stringWithFormat:@"Cnt: %tu", self.count];
